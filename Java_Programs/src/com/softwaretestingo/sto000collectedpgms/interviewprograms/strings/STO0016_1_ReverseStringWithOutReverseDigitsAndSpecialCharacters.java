...
public class STO0016_1_ReverseStringWithOutReverseDigitsAndSpecialCharacters 
{
	/**
	...
	public static void main(String[] args) 
	{
		...
		String resultString = Stream.of(str.split(" ")).map(String::toCharArray).map(STO0016_1_ReverseStringWithOutReverseDigitsAndSpecialCharacters::reverse)
