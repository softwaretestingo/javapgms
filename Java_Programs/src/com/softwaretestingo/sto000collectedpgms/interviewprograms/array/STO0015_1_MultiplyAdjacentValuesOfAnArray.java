...
public class STO0015_1_MultiplyAdjacentValuesOfAnArray 
{
	/**
	 ...
	 * The product array is : 24 12 8 6 
	 */
	...
	{
		STO0015_1_MultiplyAdjacentValuesOfAnArray pa = new STO0015_1_MultiplyAdjacentValuesOfAnArray();
		int arr[] = { 1,2,3,4 };
		int n = arr.length;
